...
$registro = $mysql -> query("SELECT * FROM registro WHERE id_cliente = '$_REQUEST[id_cliente]'") or die($mysql -> error);
...
<!-- Icons font CSS-->
    ...
    <form id="msform" action="eliminarUsuario.php" method="POST">
</head>
