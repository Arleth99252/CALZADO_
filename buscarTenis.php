...
?>
    ...
    <form id="msform" action="buscarTenis.html" method="POST">
</head>
    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Buscar Registro De Tenis</h2>
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $reg['precio'];?>" placeholder="Precio" name="precio" disabled="disabled">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value= "<?php echo $reg['color'];?>" name="color" disabled="disabled" >
                        </div>
                          <div class="input-group">
                            <input class="input--style-3" type="text" value= "<?php echo $reg['marca'];?>" name="marca" disabled="disabled" >
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value= "<?php echo $reg['tipo'];?>" name="tipo" disabled="disabled" >
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $reg['tamaño'];?>" placeholder="Tamaño" name="tamaño" disabled="disabled">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="<?php echo $reg['material'];?>" placeholder="Material" name="material" disabled="disabled">
                        </div>
                    </form>
                </div>
            </div>
